...
arm.set_position(x=150, y=116, z=200, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
time.sleep(1)
arm.set_position(x=150, y=116, z=cr.piece_height[piece], roll=-180, pitch=0, yaw=0, speed=50, wait=True)
time.sleep(1)
arm.close_lite6_gripper()
time.sleep(1)
arm.set_position(x=150, y=116, z=150, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
time.sleep(1)
arm.set_position(x=186, y=80, z=150, roll=-180, pitch=0, yaw=0, speed=50, wait=True) #36 en rute frem
time.sleep(1)
arm.set_position(x=186, y=80, z=cr.piece_height[piece], roll=-180, pitch=0, yaw=0, speed=50, wait=True)
time.sleep(1)
arm.open_lite6_gripper()
time.sleep(1)
arm.stop_lite6_gripper()
